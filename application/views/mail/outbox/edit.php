...
<section class="vbox">
    <header class="header bg-dark lt box-shadow">
        <p class="h4 font-thin m-r m-b-sm">Ubah Surat Keluar</p>         
    </header>
    <section class="scrollable">
        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
            <div class="wrapper">
                <?php echo form_open_multipart('mail/do_upload4') ?>                
                                ...
                                <div class="form-group">
                                    ...
                                    <div> 
                                        <select name="val[mail_to]" id="mail_to" class="form-control m-b">
                                            ...
                                            <option value="1" <?php echo $mail_to == 1 ? "selected" : '' ?>>Kepada</option>
                                            <option value="2" <?php echo $mail_to == 2 ? "selected" : '' ?>>Kepada</option>                                            
                                            <!--

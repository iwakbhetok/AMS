...
<section class="vbox">
    ...
    <section class="scrollable">
        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
            <div class="wrapper">
                <?php echo form_open_multipart('mail/outbox/createapproval') ?>                                
                        ...
                        <div class="row">
                            <div class="col-sm-12">                                                                                          
                                <div class="form-group"> 
                                    <label>N1</label> 
                                    <textarea class="form-control" name="val[n1]" rows="3" data-minwords="6" data-required="true" placeholder=""></textarea> 
                                </div>
                                <div class="form-group"> 
                                    <label>N2</label> 
                                    <textarea class="form-control" name="val[n2]" rows="3" data-minwords="6" data-required="true" placeholder=""></textarea> 
                                </div>
                            </div>
                        </div>                        
                    </div>

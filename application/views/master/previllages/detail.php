...
<section class="vbox">
    <header class="header bg-dark lt box-shadow">
        <p class="h4 font-thin m-r m-b-sm">Detail Biro</p>         
    </header>
    <section class="scrollable">
        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
            <div class="wrapper">                
                <form data-validate="parsley" action="<?php echo base_url('master/department/update'); ?>"  method="post">
                    <section class="panel panel-default">   
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">                                     
                                    ...
                                    <div class="form-group">                                         
                                        <div> 
                                            <input type="hidden" name="id" id="department_id" class="form-control" value="<?php echo $department_id ?>"/>
                        ...
                        <footer class="panel-footer text-right bg-light lter">
                            <a href="<?php echo base_url('master/department/edit/' . $department_id); ?>" type="submit" class="btn btn-success btn-s-xs">Ubah</a>
                            <a href="<?php echo base_url('master/department/list') ?>" type="submit" class="btn btn-danger btn-s-xs">Kembali</a>
                        </footer>
                    </section>
                </form>                
            </div>                       

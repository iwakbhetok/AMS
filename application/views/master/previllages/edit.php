...
<section class="vbox">
    <header class="header bg-dark lt box-shadow">
        <p class="h4 font-thin m-r m-b-sm">Edit Biro</p>         
    </header>
                            ...
                            <div class="row">
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <div> 
                                            <input type="text" name="val[department_name]" id="department_name" class="form-control" placeholder="Ketikkan nama biro" data-required="true" value="<?php echo $department_name; ?>">
                                        </div>
                                    </div>                                    
                                </div> 
                                <div class="col-sm-6">                                     

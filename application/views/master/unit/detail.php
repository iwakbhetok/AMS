...
<section class="vbox">
    <header class="header bg-dark lt box-shadow">
        <p class="h4 font-thin m-r m-b-sm">Detail Unit</p>         
    </header>
                ...
                <form data-validate="parsley" action="<?php echo base_url('master/unit/update'); ?>"  method="post">
                    <section class="panel panel-default">   
                        ...
                        <footer class="panel-footer text-right bg-light lter">
                            <a href="<?php echo base_url('master/unit/edit/' . $unit_id); ?>" type="submit" class="btn btn-success btn-s-xs">Ubah</a>
                            <a href="<?php echo base_url('master/unit/list') ?>" type="submit" class="btn btn-danger btn-s-xs">Kembali</a>
                        </footer>
                    </section>
                </form>                
            </div>                       

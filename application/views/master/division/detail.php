...
<section class="vbox">
    <header class="header bg-dark lt box-shadow">
        <p class="h4 font-thin m-r m-b-sm">Detail Bagian</p>         
    </header>
                ...
                <form data-validate="parsley" action="<?php echo base_url('master/division/update'); ?>"  method="post">
                    <section class="panel panel-default">   
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">                                     
                                    ...
                                    <div class="form-group">                                         
                                        <div> 
                                            <input type="hidden" name="id" id="division_id" class="form-control" value="<?php echo $division_id ?>"/>
                        ...
                        <footer class="panel-footer text-right bg-light lter">
                            <a href="<?php echo base_url('master/division/edit/' . $division_id); ?>" type="submit" class="btn btn-success btn-s-xs">Ubah</a>
                            <a href="<?php echo base_url('master/division/list') ?>" type="submit" class="btn btn-danger btn-s-xs">Kembali</a>
                        </footer>
                    </section>
                </form>                
            </div>                       

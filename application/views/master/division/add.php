...
<section class="vbox">
    <header class="header bg-dark lt box-shadow">
        <p class="h4 font-thin m-r m-b-sm">Tambah Bagian</p>         
    </header>
    <section class="scrollable">
        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
            <div class="wrapper">                
                <form data-validate="parsley" action="<?php echo base_url('master/division/create'); ?>"  method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <div> 
                                            <input type="text" name="val[division_name]" id="division_name" class="form-control" placeholder="Ketikkan nama bagian" data-required="true">
                                        </div>
                                    </div>                                    
                                </div>
                                <div class="col-sm-6">                                     

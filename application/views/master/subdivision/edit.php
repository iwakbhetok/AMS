...
<section class="vbox">
    ...
    <section class="scrollable">
        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
            <div class="wrapper">                
                <form data-validate="parsley" action="<?php echo base_url('master/subdivision/update'); ?>"  method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <div> 
                                            <input type="text" name="val[sub_division_name]" id="sub_division_name" class="form-control" placeholder="Ketikkan nama sub bagian" data-required="true" value="<?php echo $sub_division_name; ?>">
                                        </div>
                                    </div>                                    
                                </div>
                                <div class="col-sm-6">                                     
                                    ...
                                    <div class="form-group">                                         
                                        <div> 
                                            <input type="hidden" name="id" id="sub_division_id" class="form-control" value="<?php echo $sub_division_id ?>"/>
